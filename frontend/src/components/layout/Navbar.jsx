  ...
  return (
    ...
    >
      <div className="container-custom">
            ...
            {navItems.map((item) => (
              ...
              >
                ...
                {item.dropdown && activeDropdown === item.name && (
                  <div className="absolute top-full left-0 w-52 bg-white shadow-lg border border-slate-100 py-2 animate-fade-in-up">
        ...
        {/* Mobile Menu */}
        {isOpen && (
          <div className="lg:hidden py-4 border-t border-slate-100 animate-fade-in-up" data-testid="mobile-menu">
            {navItems.map((item) => (
              <div key={item.name}>
                <Link
                  to={item.path}
