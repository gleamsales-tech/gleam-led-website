...
const Home = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [productsRes, useCasesRes] = await Promise.all([
            ...
            <div className="animate-fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-slate-900 text-white px-8 py-4 font-medium hover:bg-slate-800 transition-all btn-glow"
                >
                  Get Free Quote
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, idx) => (
              <div
                key={idx}
                className="group p-8 bg-slate-50 hover:bg-white hover:shadow-xl border border-transparent hover:border-slate-100 transition-all duration-300 animate-fade-in-up"
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {useCases.slice(0, 4).map((useCase, idx) => (
              <div
                key={useCase.id}
                className="group relative h-80 overflow-hidden animate-fade-in-up"
                style={{ animationDelay: `${idx * 100}ms` }}
              >
                <img
                  src={useCase.image}
